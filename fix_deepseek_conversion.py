...
def fix_tokenizer_hash():
    ...
    # Find the hash checking section and add our new hash
    target_line = '        if chkhsh == "cdf5f35325780597efd76153d4d1c16778f766173908894c04afc20108536267":'
    new_hash_line = '        if chkhsh == "b0d03e997351c41b4ba8013dc400510737f9a9029a417c7c148516323dca908c":  # DeepSeek-R1-Distill-Qwen-7B-Developer'
    new_pre_tokenizer = '            res = "qwen2"'
    
    # Add our hash after the existing ones
